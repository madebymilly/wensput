...
export function filterProducts(products, answers) {
  ...
  // For eacht answer given, filter all products:
  answers.forEach(answer => {
    ...
    filteredProducts = products.filter(product => {
      ...
      categoryFilter = answer.category && answer.category.some(
      ...
      return categoryFilter && nonCategoryFilter && tagFilter && nonTagFilter;
    });
  });
  ...
  //   durationFilter = answers.duration && answers.duration.some(
  ...
  //   return audioFile && (categoryFilter || nonCategoryFilter) && (tagFilter || nonTagFilter) && playersFilter && durationFilter;
